"""
Android server — identical interface to desktop/runtime/runner/server.py.
Werkzeug is cross-platform; no changes needed for Android.
"""
import os
import socket
import sys
...
def configure_frappe_env() -> None:
    ...
    os.environ.setdefault("FRAPPE_SQLITE_DESKTOP", "1")   # keeps existing compat flag
